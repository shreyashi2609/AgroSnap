...
| Upload & Analyze | Analysis Results | Market Prices |
|:---:|:---:|:---:|
| *Upload crop images for instant analysis* | *Detailed disease detection & advice* | *Real-time mandi rates across India* |

*(Note: Add actual screenshots here for a complete professional look)*
